...
namespace ControleSalasPortal.Controllers
{
    public class ProfessorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Status,Sala,Agenda")] Professor professor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Status,Sala,Agenda")] Professor professor)
        {
            if (id != professor.Id)
            {
                return NotFound();
