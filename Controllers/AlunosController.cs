...
namespace ControleSalasPortal.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Turma,Periodo,Sala")] Alunos alunos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Turma,Periodo,Sala")] Alunos alunos)
        {
            if (id != alunos.Id)
            {
                return NotFound();
